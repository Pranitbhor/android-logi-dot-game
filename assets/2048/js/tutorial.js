...
var TutorialMessages = [
  ...
  { msg: 'Pink dots can see others <br>in their own row and column <span id="nextdot"></span>', tiles: [], next: true },
  { msg: 'Green dots block their view <span id="nextdot" class="red"></span>', tiles: [ ], next: true },
  { msg: 'Numbers tell how many others each Pink dot can see <span id="nextdot"></span>', tiles: [], next: true },
  ...
  { msg: 'These two. <br>Tap to make them Pink <span id="nextdot"></span>', tiles: [ [1,0,2],[2,0,2] ] },
  { msg: 'Now close its path.<br>Tap twice for a Green dot <span id="nextdot" class="red"></span>', tiles: [ /*[0,0],[1,0],[2,0],*/[3,0,1] ] },
  { msg: 'This 1 can see only one. <br>It already does - below <span id="nextdot"></span>', tiles: [ [3,1] ], next: true },
  { msg: 'So a Green dot must be <br>blocking its view here <span id="nextdot" class="red"></span>', tiles: [ [2,1,1] ] },
